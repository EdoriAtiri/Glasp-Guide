...
2. Click "Sign up (beta)" at the top right-hand corner of your screen. This action will redirect you to the signup page.
   ![Sign Up to Glasp](./files/glasp_home.png)
...
3. Click "Continue with Google" on the right side of the signup page to sign up. Doing this will trigger a Google authentication sign-in page.
   ![Contunue with google](./files/sign_up_google.png)
...
8. Select Glasp's extension icon in the browser's extension toolbar.
   ![Pin Glasp](./files/pin_glasp.png)

9. Look for Glasp in the dropdown list.
   ![Pin Glasp 2](./files/pin_glasp_2.png)

10. Toggle the Pin icon on. Now the Glasp extension should show up on the toolbar.
    ![Pin Glasp 3](./files/pin_glasp_3.png)

11. Click on Glasp's extension icon to start it. The extension referred to as the "Glasp Sidebar" should take up a small portion of the right side of your browser window. You should be already signed in. If you are not signed in, click "Log in / Sign up" to proceed and follow steps 3 and 4.
    ![Glasp extension open](./files/glasp_extension_open.png)
    Glasp Sidebar signed in
    ![glasp extension sign in](./files/)
    Not signed in. click Log in / Sign up to proceed
...
2. Choose your favorite topics and click save for personalizing your feed. You can choose up to 10 topics. After saving, you will see your profile page.
...
1. Highlight the text you want or click on text you have previously highlighted
2. Select the note-writing icon "✍️" from the menu, as seen in the image below.
   ![add note to highlight](./files/add_note.png)
...
2. Tap the quote icon from the menu to create a Quoteshot. A card with the image will pop up
   ![click highlighted text](./files/quoteshot.png)
...
2. Click the Twitter icon from the menu that pops up. Doing this will open up a new window on Twitter with the quote and the website you got it from
   ![share to twitter](./files/share_tweet.png)
...
2. Select the color you used in highlighting the text to delete it. The color will have an "X" sign on top of it
   ![delete highlight](./files/delete.png)
...
3. Click the three-dotted menu in the top right corner of the highlights card
   ![hover over an highlight](./files/hover_highlight.png)
...
_An example of copied highlight embed code_
...
4. Filter your highlights with a tag by selecting it from the tag section of the highlights page
   ![filter highlights with tag](./files/filter_with_tags.png)
...
![open settings by right clicking the extension icon and select options](./files/settings_3.png)
...
![click settings](./files/settings.png)
![click settings](./files/settings_3.png)
